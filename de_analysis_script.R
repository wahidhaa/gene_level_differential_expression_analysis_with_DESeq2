...
# Adapted from the Harvard Chan Bioinformatics Cose (HBC)
# self-learning workshop: "Introduction to DGE"
...
## ---- Load all packages to confirm successful installation ----
library(DESeq2)
library(tidyverse)
...
# ============================= 2. PROJECT SET-UP =====================
# File menu > New Project > New Directory > New Project > name "DEanalysis"
...
# Create "data", "meta" and "results" subfolders in the Files panel (bottom-right)
# Download the Salmon pseudocount folders and the tx2gene annotation file
# into the "data" subfolder before continuing.

# File menu > New File > R Script > save as "de_analysis_script.R"
